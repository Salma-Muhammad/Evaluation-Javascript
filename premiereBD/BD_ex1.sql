...
-- Listage de la structure de la base pour exercice1
CREATE DATABASE IF NOT EXISTS `exercice1` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `exercice1`;

-- Listage de la structure de la table exercice1. appartient
...
-- Listage des données de la table exercice1.appartient : ~0 rows (environ)
/*!40000 ALTER TABLE `appartient` DISABLE KEYS */;
/*!40000 ALTER TABLE `appartient` ENABLE KEYS */;

-- Listage de la structure de la table exercice1. groupe
...
-- Listage des données de la table exercice1.groupe : ~0 rows (environ)
/*!40000 ALTER TABLE `groupe` DISABLE KEYS */;
/*!40000 ALTER TABLE `groupe` ENABLE KEYS */;

-- Listage de la structure de la table exercice1. personne
...
-- Listage des données de la table exercice1.personne : ~0 rows (environ)
