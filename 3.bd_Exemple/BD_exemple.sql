...
-- Listage de la structure de la base pour exemple
CREATE DATABASE IF NOT EXISTS `exemple` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `exemple`;

-- Listage de la structure de la table exemple. dept
...
-- Listage des données de la table exemple.dept : ~14 rows (environ)
...
-- Listage de la structure de la table exemple. employe
...
-- Listage des données de la table exemple.employe : ~25 rows (environ)
